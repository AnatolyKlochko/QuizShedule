...
require_once($CFG->dirroot . '/mod/quizschedule/quizscheduleplugin.php');
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class quizschedule_synchronization_plugin extends quizschedule_plugin {
    ...
    public final function get_subtype() {
        return 'quizschedulesynchronization';
    }
