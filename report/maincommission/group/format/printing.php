...
use quizschedulemaincommission_group\format\report;
use quizschedulemaincommission_group\format\printing\output\renderer;
...
require_once( __DIR__ . '/../../../../lib.php'); // sadly, but Moodle doesn't autoload this file
