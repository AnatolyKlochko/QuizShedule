...
class add_plan_renderer {
    ...
    public function display() {
        ...
        // Page settings
        $url = new \moodle_url('/mod/quizschedule/add_plan.php', []);
        $PAGE->set_url($url);
        ...
        //     
        // Custom CSS
        $PAGE->requires->css( new \moodle_url( $CFG->wwwroot . '/mod/quizschedule/styles/add-plan/add-plan.css' ) );
        ...
        $PAGE->requires->js( new \moodle_url( $CFG->wwwroot . '/mod/quizschedule/jquery/add_plan.js' ) );
        
        
        
        
        // Page
        $PAGE->set_title( get_string( 'add_plan_title', 'quizschedule' ) );
        $PAGE->set_heading( get_string( 'add_plan_heading', 'quizschedule' ) );

        echo $OUTPUT->header();
        
        $this->display_add_plan();
//        $aco = ( new helper )->get_user_groups( $USER );
//        
...
//        }
    ...
    private function display_add_plan() {
        global $USER;
        ...
        // Display View
        include helper::modroot() . '/view/add_plan.php';
    }
