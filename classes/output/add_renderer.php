...
class add_renderer {
    ...
    public function display() {
        ...
        // Page settings
        $url = new \moodle_url('/mod/quizschedule/add.php', []);
        $PAGE->set_url($url);
        ...
        //     
        // Custom CSS
        $PAGE->requires->css( new \moodle_url( $CFG->wwwroot . '/mod/quizschedule/styles/add/add.css' ) );
        ...
        $PAGE->requires->js( new \moodle_url( $CFG->wwwroot . '/mod/quizschedule/jquery/add.js' ) );
        
        
        
        
        // Page
        $PAGE->set_title( get_string( 'add_title', 'quizschedule' ) );
        $PAGE->set_heading( get_string( 'add_heading', 'quizschedule' ) );
    ...
    private function display_add() {
        ...
        // Display View
        include helper::modroot() . '/view/add.php';
    }
