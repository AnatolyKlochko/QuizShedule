...
class redundant_data_renderer {
    ...
    public function display() {
        ...
        // Page settings
        $url = new \moodle_url('/mod/quizschedule/redundant_data.php', []);
        $PAGE->set_url($url);
        ...
        //     
        // Custom CSS
        $PAGE->requires->css( new \moodle_url( $CFG->wwwroot . '/mod/quizschedule/styles/redundant-data/redundant-data.css' ) );
        ...
        $PAGE->requires->js( new \moodle_url( $CFG->wwwroot . '/mod/quizschedule/jquery/redundant_data.js' ) );
        
        
        
        
        // Page
        $PAGE->set_title( get_string( 'redundant_data_title', 'quizschedule' ) );
        $PAGE->set_heading( get_string( 'redundant_data_heading', 'quizschedule' ) );

        echo $OUTPUT->header();
        
        $this->display_redundant_data();
...
//        }
    ...
    private function display_redundant_data() {
        global $USER;
        ...
        // Display View
        include helper::modroot() . '/view/redundant_data.php';
    }
